 ...
 * 
 * Esta aplicação implementa um motor de regras configurável para análise e prevenção
 * de fraudes em transações de crédito, com suporte a auditoria completa e compliance.
 */
