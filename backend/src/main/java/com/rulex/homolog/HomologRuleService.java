...
public class HomologRuleService {
    ...
    public HomologRuleService(RuleRepository ruleRepository, RuleVersionRepository ruleVersionRepository, ObjectMapper objectMapper, HomologAuditService audit, ActorResolver actorResolver) {
    ...
    public RuleVersionResponse create(String actorEmail, CreateRuleRequest req) {
        ...
        audit.success(actorEmail, AuditActionType.RULE_CREATED, "rule", rule.getId().toString(),
    ...
    public RuleVersionResponse publish(String actorEmail, UUID ruleVersionId) {
        RuleVersionEntity v = ruleVersionRepository.findById(ruleVersionId)
        ...
        audit.success(actorEmail, AuditActionType.RULE_PUBLISHED, "rule_versions", v.getId().toString(),
    ...
    public RuleVersionResponse rollbackToVersion(String actorEmail, UUID ruleId, int version) {
        ...
        RuleVersionEntity base = ruleVersionRepository.findByRuleIdAndVersion(ruleId, version)
        ...
        audit.success(actorEmail, AuditActionType.RULE_UPDATED, "rules", ruleId.toString(),
