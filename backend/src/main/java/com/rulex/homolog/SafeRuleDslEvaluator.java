...
public class SafeRuleDslEvaluator {

    private final ObjectMapper objectMapper;

    public SafeRuleDslEvaluator(ObjectMapper objectMapper) {
    ...
    private int compare(Object actual, String expectedRaw) {
        ...
        throw new IllegalArgumentException("Comparação não suportada para tipo: " + actual.getClass().getSimpleName());
    }
