...
/**
 * Controller para gerenciamento de regras complexas. API para gerenciamento de regras complexas com
 * grupos aninhados.
 */
@RestController
...
public class ComplexRuleController {
  ...
  public ResponseEntity<ConditionGroupDTO> saveConditionGroup(
      @PathVariable UUID ruleVersionId, @Valid @RequestBody ConditionGroupDTO conditionGroup) {
  ...
  public ResponseEntity<List<ExpressionDTO>> saveExpressions(
      @PathVariable UUID ruleVersionId, @Valid @RequestBody List<ExpressionDTO> expressions) {
  ...
  public ResponseEntity<List<ContextVariableDTO>> saveContextVariables(
      @PathVariable UUID ruleVersionId, @Valid @RequestBody List<ContextVariableDTO> variables) {
    log.info("Salvando {} variáveis de contexto para regra: {}", variables.size(), ruleVersionId);
    List<ContextVariableDTO> saved =
  ...
  public ResponseEntity<List<ContextVariableDTO>> getContextVariables(
  ...
  public ResponseEntity<List<RuleActionDTO>> saveActions(
      @PathVariable UUID ruleVersionId, @Valid @RequestBody List<RuleActionDTO> actions) {
  ...
  public ResponseEntity<Map<String, Object>> validateDepth(
      @PathVariable UUID ruleVersionId, @RequestParam(defaultValue = "10") int maxDepth) {
  ...
  public ResponseEntity<ComplexRuleEvaluator.EvaluationResult> evaluateRule(
      @PathVariable UUID ruleVersionId, @RequestBody Map<String, Object> payload) {
    ...
    // Avaliar
    ComplexRuleEvaluator.EvaluationResult result =
        complexRuleEvaluator.evaluate(groupEntity, context);
