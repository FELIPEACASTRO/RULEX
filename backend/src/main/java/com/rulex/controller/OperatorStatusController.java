 ...
 * 
 * <p>Permite verificar quais operadores estão implementados (STABLE)
 * e quais estão planejados (PLANNED).
 */
@RestController
...
public class OperatorStatusController {
    ...
    @Operation(
        ...
        description = "Retorna estatísticas e lista de operadores agrupados por status (STABLE, PLANNED, etc.)"
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Retorna detalhes sobre um operador, incluindo status, avaliador e se está implementado"
    )
    @ApiResponses({
