 ...
 *
 * <ul>
 *   <li>rulex:velocity:count:pan:abc123:5min
 *   <li>rulex:cache:rules:rule-001
 *   <li>rulex:session:user-123
 * </ul>
 */
public final class RedisKeyConvention {
  ...
  /**
   * Sanitiza uma string para uso como parte de chave Redis. Remove caracteres especiais e converte
   * para lowercase.
   */
  public static String sanitizeKey(String input) {
    if (input == null) return "null";
    return input.toLowerCase().replaceAll("[^a-z0-9_-]", "_").replaceAll("_+", "_");
  }
