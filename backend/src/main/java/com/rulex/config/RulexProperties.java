...
/**
 * QUAL-002 FIX: Propriedades centralizadas do RULEX. Substitui magic numbers hardcoded por
 * configurações externalizáveis.
 *
 * <p>Uso: @Autowired RulexProperties props; Exemplo: props.getLimits().getMaxRequestBodySize()
 */
@Configuration
...
public class RulexProperties {
  ...
  @NotNull private Limits limits = new Limits();

  @NotNull private Velocity velocity = new Velocity();

  @NotNull private Fraud fraud = new Fraud();

  @NotNull private Cache cache = new Cache();
