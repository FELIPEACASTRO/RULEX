 ...
 * 
 * <p>Esta interface define o contrato para todos os engines de regras,
 * permitindo consolidacao futura dos 5 engines existentes:
 * - ComplexRuleEvaluator
 * - RuleEngineService
 * - DatabaseRuleExecutorService
 * - AdvancedRuleEngineService
 * - AstEvaluator
 * 
...
public interface RuleEvaluator {
    ...
    record EvaluationResult(
        ...
        public static EvaluationResult approved(String evaluatorName, long executionTimeMs) {
            return new EvaluationResult(false, "APPROVED", 0.0, java.util.List.of(), executionTimeMs, evaluatorName);
        }

        public static EvaluationResult declined(String evaluatorName, double riskScore, 
                java.util.List<TriggeredRule> triggeredRules, long executionTimeMs) {
            return new EvaluationResult(true, "DECLINED", riskScore, triggeredRules, executionTimeMs, evaluatorName);
        }
    }
