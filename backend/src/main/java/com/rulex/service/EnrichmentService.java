...
/**
 * Serviço de enriquecimento de transações.
 * Adiciona informações derivadas do BIN e MCC sem alterar o payload original.
 * 
 * <p>Todos os enriquecimentos têm fallback para valores padrão ("UNKNOWN")
 * para garantir que o fluxo nunca seja interrompido por falta de dados.
 */
@Service
...
public class EnrichmentService {
    ...
    public EnrichmentContext enrich(TransactionRequest request) {
        ...
        log.debug("Enriquecimento completo: bin={}, cardBrand={}, mcc={}, mccCategory={}, mccRiskLevel={}",
    ...
    public BinEnrichment enrichBin(String bin) {
        ...
        try {
            ...
            return BinEnrichment.builder()
                    ...
                    .issuerCountryNumeric(lookup.getIssuerCountryNumeric() != null ? lookup.getIssuerCountryNumeric() : "UNKNOWN")
