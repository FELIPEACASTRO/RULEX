...
/**
 * Evaluator para operadores de Platform Best Practices. Implementa funcionalidades inspiradas em
 * FICO, Feedzai, SAS, Stripe, Adyen, PayPal.
 */
@Component
@Slf4j
public class PlatformOperatorEvaluator implements OperatorEvaluator {
  ...
  public boolean evaluate(RuleCondition condition, EvaluationContext context) {
    ...
    return switch (condition.getOperator()) {
      ...
      case PLT_BUSINESS_RULES_SCENARIO ->
          evaluateBusinessRulesScenario(fieldValue, threshold, payload);
      ...
      case PLT_NETWORK_ENTITY_RESOLUTION ->
          evaluateNetworkEntityResolution(fieldValue, threshold, payload);
      case PLT_SCENARIO_SCORECARD -> evaluateScenarioScorecard(fieldValue, threshold, payload);
        // Stripe
      case PLT_RADAR_RULE_BACKTESTING ->
          evaluateRadarRuleBacktesting(fieldValue, threshold, payload);
      case PLT_RADAR_METADATA_MATCHING ->
          evaluateRadarMetadataMatching(fieldValue, threshold, payload);
      case PLT_RADAR_INLINE_LISTS -> evaluateRadarInlineLists(fieldValue, threshold, payload);
      case PLT_RADAR_COMPLEX_CONDITIONS ->
          evaluateRadarComplexConditions(fieldValue, threshold, payload);
        // Adyen
      case PLT_RISK_PROFILE_ASSIGNMENT ->
          evaluateRiskProfileAssignment(fieldValue, threshold, payload);
      ...
      case PLT_RISK_SCORE_CALCULATION ->
          evaluateRiskScoreCalculation(fieldValue, threshold, payload);
  ...
  private boolean evaluateBehaviorSortedLists(
  ...
  private boolean evaluateBusinessRulesScenario(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateIdentityResolution(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    try {
  ...
  private boolean evaluateCompromiseManager(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateIntelligenceNetwork(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }
  ...
  private boolean evaluateRulesModelsHybrid(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    try {
  ...
  private boolean evaluateBehavioralProfiling(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
  ...
  private boolean evaluateNetworkAnalytics(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateSarAutomated(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
  ...
  private boolean evaluateDs2RuleEngine(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateRealTimeDetection(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
  ...
  private boolean evaluateNetworkEntityResolution(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateScenarioScorecard(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    try {
      double score = Double.parseDouble(fieldValue.toString());
  ...
  private boolean evaluateRadarRuleBacktesting(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateRadarMetadataMatching(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
  ...
  private boolean evaluateRadarInlineLists(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
  ...
  private boolean evaluateRadarComplexConditions(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }
  ...
  private boolean evaluateRiskProfileAssignment(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateCustomRuleBuilder(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateRiskListComparison(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
        || "MATCH".equalsIgnoreCase(String.valueOf(fieldValue));
  ...
  private boolean evaluateBacktestingLabeling(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateMlFraudRiskOutcome(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    try {
  ...
  private boolean evaluateRiskScoreCalculation(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    try {
      double score = Double.parseDouble(fieldValue.toString());
      double minScore = threshold != null ? Double.parseDouble(threshold) : 50;
  ...
  private boolean evaluateVelocityFilters(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    try {
  ...
  private boolean evaluateLinkingVelocity(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    try {
  ...
  private boolean evaluateBadEntityNetwork(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
  ...
  private boolean evaluateReviewlistQueue(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
  ...
  private boolean evaluateConsortiumDataCheck(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    return Boolean.TRUE.equals(fieldValue)
        || "true".equalsIgnoreCase(String.valueOf(fieldValue))
