 ...
 * <ul>
 *   <li>DATE_BEFORE, DATE_AFTER - comparação de datas</li>
 *   <li>DATE_BETWEEN - intervalo de datas</li>
 *   <li>TIME_BETWEEN - intervalo de horários</li>
 *   <li>HOUR_BETWEEN - intervalo de horas</li>
 *   <li>DAY_OF_WEEK_IN - dias da semana</li>
 *   <li>IS_WEEKEND - fim de semana</li>
 *   <li>IS_BUSINESS_HOURS - horário comercial</li>
 *   <li>DATE_DIFF_DAYS_LT/GT - diferença em dias</li>
 * </ul>
 */
@Component
@Slf4j
public class DateTimeOperatorEvaluator implements OperatorEvaluator {
    ...
    public boolean evaluate(RuleCondition condition, EvaluationContext context) {
        ...
        return switch (op) {
            ...
            case HOUR_BETWEEN -> evaluateHourBetween(fieldValue, condition.getValueMin(), condition.getValueMax());
    ...
    private boolean evaluateDateDiffDays(Object fieldValue, String compareDate, Integer threshold, boolean lessThan) {
        LocalDate fieldDate = parseDate(fieldValue);
