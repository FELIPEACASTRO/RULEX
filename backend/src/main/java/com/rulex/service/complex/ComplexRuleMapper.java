...
public class ComplexRuleMapper {
     ...
     */
    public RuleConditionGroup toEntity(ConditionGroupDTO dto, java.util.UUID ruleVersionId, java.util.UUID parentGroupId) {
    ...
    private RuleConditionGroup.GroupLogicOperator mapLogicOperator(ConditionGroupDTO.LogicOperatorType type) {
    ...
    private ConditionGroupDTO.LogicOperatorType mapLogicOperatorToDTO(RuleConditionGroup.GroupLogicOperator type) {
