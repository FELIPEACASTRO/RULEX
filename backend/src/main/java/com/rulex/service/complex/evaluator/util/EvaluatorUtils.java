 ...
 * <ul>
 *   <li>Parsing seguro de valores (Long, Integer, Double, BigDecimal)</li>
 *   <li>Extração de valores do contexto e payload</li>
 *   <li>Conversão de tipos</li>
 *   <li>Tratamento de exceções com logging adequado</li>
 * </ul>
 *
 * @version 1.0.0
 * @since 1.3.1
...
public final class EvaluatorUtils {
     ...
     */
    public static String getStringValue(String fieldName, EvaluationContext context, String defaultValue) {
     ...
     */
    public static double getDoubleValue(String fieldName, EvaluationContext context, double defaultValue) {
        return getFieldValue(fieldName, context)
            .map(v -> {
     ...
     */
    public static BigDecimal getBigDecimalValue(String fieldName, EvaluationContext context, BigDecimal defaultValue) {
        return getFieldValue(fieldName, context)
     ...
     */
    public static boolean getBooleanValue(String fieldName, EvaluationContext context, boolean defaultValue) {
        return getFieldValue(fieldName, context)
            .map(EvaluatorUtils::toBoolean)
            .orElse(defaultValue);
    }
    ...
    public static boolean toBoolean(Object value) {
        ...
        return "true".equals(str) || "1".equals(str) || "yes".equals(str) || "y".equals(str) || "sim".equals(str);
    }
    ...
    public static boolean evaluateSafely(
        ...
        try {
            ...
            log.warn("Erro ao avaliar operador {}: {} - {}",
                operatorName, e.getClass().getSimpleName(), e.getMessage());
    ...
    public static boolean evaluateOrThrow(
        ...
        try {
            ...
            throw new RuleEvaluationException(
                operatorName,
                String.format("Falha ao avaliar no campo %s: %s",
                    condition.getFieldName(), e.getMessage()),
                e);
        }
    }
     ...
     */
    public static double[] parseThresholdAndWindow(String valueSingle, double defaultThreshold, double defaultWindow) {
    ...
    public static int getDayOfWeek(Object timestamp) {
        ...
        String str = String.valueOf(timestamp);
        return parseDateTime(str)
            .map(dt -> dt.getDayOfWeek().getValue())
            .orElse(-1);
    }
     ...
     */
    public static void logEvaluation(String operatorName, String fieldName, Object fieldValue, Object conditionValue, boolean result) {
        if (log.isDebugEnabled()) {
            log.debug("Operador {}: field={}, value={}, condition={}, result={}",
                operatorName, fieldName, fieldValue, conditionValue, result);
        }
    }
