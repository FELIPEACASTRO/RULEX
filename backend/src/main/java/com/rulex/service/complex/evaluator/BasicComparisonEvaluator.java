 ...
 * <ul>
 *   <li>EQ, NEQ - igualdade</li>
 *   <li>GT, GTE, LT, LTE - comparação numérica</li>
 *   <li>IN, NOT_IN - pertencimento a lista</li>
 *   <li>BETWEEN, NOT_BETWEEN - intervalo</li>
 *   <li>IS_NULL, NOT_NULL - nulidade</li>
 *   <li>IS_TRUE, IS_FALSE - booleano</li>
 * </ul>
 */
@Component
@Slf4j
public class BasicComparisonEvaluator implements OperatorEvaluator {
    ...
    public boolean evaluate(RuleCondition condition, EvaluationContext context) {
        ...
        log.debug("BasicComparisonEvaluator: op={}, field={}, value={}, expected={}",
            op, fieldName, fieldValue, condition.getValueSingle());
