 ...
 * <ul>
 *   <li>DEVICE_CHANGED_IN_SESSION - mudança de dispositivo na sessão</li>
 *   <li>DEVICE_JAILBREAK_ROOTED - dispositivo com jailbreak/root</li>
 *   <li>EMULATOR_DETECTION - detecção de emulador</li>
 *   <li>VPN_PROXY_DETECTION - detecção de VPN/Proxy</li>
 *   <li>TOR_EXIT_NODE - nó de saída Tor</li>
 *   <li>BROWSER_INCONSISTENCY - inconsistência de browser</li>
 *   <li>DEVICE_TRUST_SCORE - score de confiança do dispositivo</li>
 * </ul>
 */
@Component
@Slf4j
public class DeviceOperatorEvaluator implements OperatorEvaluator {
    ...
    public boolean evaluate(RuleCondition condition, EvaluationContext context) {
        ...
        try {
            return switch (op) {
                ...
                case DEVICE_FINGERPRINT_CONSISTENCY_CHECK -> evaluateFingerprintConsistency(request, payload);
    ...
    private boolean evaluateDeviceChanged(TransactionRequest request, Map<String, Object> payload, RuleCondition condition) {
        ...
        log.debug("DEVICE_CHANGED_IN_SESSION: current={}, previous={}, changed={}",
            currentDevice, previousDevice, changed);
        return changed;
    }
    ...
    private boolean evaluateJailbreakRooted(TransactionRequest request, Map<String, Object> payload) {
        ...
        boolean result = Boolean.TRUE.equals(isJailbroken) ||
                        Boolean.TRUE.equals(isRooted) ||
                        Boolean.TRUE.equals(deviceCompromised);
        log.debug("DEVICE_JAILBREAK_ROOTED: jailbroken={}, rooted={}, compromised={}",
            isJailbroken, isRooted, deviceCompromised);
        return result;
    }
    ...
    private boolean evaluateVpnProxy(TransactionRequest request, Map<String, Object> payload) {
        ...
        boolean result = Boolean.TRUE.equals(isVpn) ||
    ...
    private boolean evaluateBrowserInconsistency(TransactionRequest request, Map<String, Object> payload) {
    ...
    private boolean evaluateDeviceTrustScore(TransactionRequest request, Map<String, Object> payload, RuleCondition condition) {
    ...
    private boolean evaluateMemoryAnomaly(TransactionRequest request, Map<String, Object> payload) {
        ...
        boolean result = Boolean.TRUE.equals(hasMemoryAnomaly) || Boolean.TRUE.equals(hasHookingDetected);
        log.debug("DEVICE_MEMORY_ANOMALY: memoryAnomaly={}, hooking={}", hasMemoryAnomaly, hasHookingDetected);
        return result;
    }

    private boolean evaluateSharedDeviceCount(TransactionRequest request, Map<String, Object> payload, RuleCondition condition) {
    ...
    private boolean evaluateDeviceAccountRatio(TransactionRequest request, Map<String, Object> payload, RuleCondition condition) {
    ...
    private boolean evaluateFingerprintConsistency(TransactionRequest request, Map<String, Object> payload) {
    ...
    private boolean evaluateAntiDetectBrowser(TransactionRequest request, Map<String, Object> payload) {
        ...
        boolean result = Boolean.TRUE.equals(isAntiDetect) ||
                        Boolean.TRUE.equals(hasCanvasManipulation) ||
                        Boolean.TRUE.equals(hasWebGLManipulation);
        log.debug("ANTI_DETECT_BROWSER: antiDetect={}, canvas={}, webgl={}",
            isAntiDetect, hasCanvasManipulation, hasWebGLManipulation);
        return result;
    }
