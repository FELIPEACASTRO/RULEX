 ...
 * <ul>
 *   <li>CONTAINS, NOT_CONTAINS - substring</li>
 *   <li>STARTS_WITH, ENDS_WITH - prefixo/sufixo</li>
 *   <li>REGEX_MATCH - expressão regular</li>
 *   <li>LIKE, NOT_LIKE - padrão SQL LIKE</li>
 *   <li>SOUNDEX_MATCH - similaridade fonética</li>
 *   <li>LEVENSHTEIN_LT - distância de edição</li>
 *   <li>LENGTH_EQ, LENGTH_GT, LENGTH_LT - tamanho</li>
 * </ul>
 */
@Component
@Slf4j
