 ...
 *
 * <ul>
 *   <li>GEO_DISTANCE_LT, GEO_DISTANCE_GT - distância entre pontos
 *   <li>GEO_IN_POLYGON - ponto dentro de polígono
 * </ul>
 */
@Component
...
public class GeoOperatorEvaluator implements OperatorEvaluator {
  ...
  private boolean evaluateGeoDistanceGt(TransactionRequest request, RuleCondition condition) {
    ...
    GeoResult result =
        geoService.evaluateDistanceGreaterThan(request, refLat, refLon, minDistanceKm);
