...
/**
 * Evaluator para operadores FATF (Financial Action Task Force). Implementa tipologias de lavagem de
 * dinheiro conforme FATF.
 *
 * <p>Categorias: - Placement: Colocação de fundos ilícitos no sistema financeiro - Layering:
 * Camadas de transações para ocultar origem - Integration: Integração de fundos lavados na economia
 * legítima - TBML: Trade-Based Money Laundering
 */
@Component
@Slf4j
public class FATFOperatorEvaluator implements OperatorEvaluator {
  ...
  public boolean evaluate(RuleCondition condition, EvaluationContext context) {
    ...
    return switch (condition.getOperator()) {
      ...
      case FATF_PLACEMENT_CURRENCY_EXCHANGE ->
          evaluateCurrencyExchange(fieldValue, threshold, payload);
      ...
      case FATF_LAYERING_CONVERTIBLE_INSTRUMENTS ->
          evaluateConvertibleInstruments(fieldValue, threshold, payload);
        // Integration
      ...
      case FATF_INTEGRATION_BUSINESS_INVESTMENT ->
          evaluateBusinessInvestment(fieldValue, threshold, payload);
      ...
      case FATF_TBML_MULTIPLE_INVOICING ->
          evaluateMultipleInvoicing(fieldValue, threshold, payload);
      ...
      case FATF_NEW_PAYMENT_EXPLOITATION ->
          evaluateNewPaymentExploitation(fieldValue, threshold, payload);
      ...
      case FATF_CORRESPONDENT_LAYERING ->
          evaluateCorrespondentLayering(fieldValue, threshold, payload);
      case FATF_ROUND_TRIPPING -> evaluateRoundTripping(fieldValue, threshold, payload);
      case FATF_BLACK_MARKET_EXCHANGE ->
          evaluateBlackMarketExchange(fieldValue, threshold, payload);
  ...
  private boolean evaluateCashIntensive(
  ...
  private boolean evaluateStructuring(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateSmurfing(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateCurrencyExchange(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateCasinoGambling(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateRapidMovement(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateShellCompany(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateOffshore(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateWireChains(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateConvertibleInstruments(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateRealEstate(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateLuxuryGoods(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateBusinessInvestment(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateLoanRepayment(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateOverInvoicing(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateUnderInvoicing(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluatePhantomShipping(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateMultipleInvoicing(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateFalseDescription(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateNewPaymentExploitation(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    // Verifica exploração de novos métodos de pagamento
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateCryptoMixing(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateCryptoAtmCashout(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluatePepTransaction(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateCorrespondentLayering(
      Object fieldValue, String threshold, Map<String, Object> payload) {
  ...
  private boolean evaluateRoundTripping(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    // Verifica round-tripping (dinheiro sai e volta)
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateBlackMarketExchange(
      Object fieldValue, String threshold, Map<String, Object> payload) {
    // Verifica câmbio no mercado negro
    return Boolean.TRUE.equals(fieldValue) || "true".equalsIgnoreCase(String.valueOf(fieldValue));
  }

  private boolean evaluateInsuranceCashValue(
      Object fieldValue, String threshold, Map<String, Object> payload) {
