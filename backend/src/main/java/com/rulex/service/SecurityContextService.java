...
/**
 * Serviço para obter informações do contexto de segurança.
 * Centraliza a lógica de identificação do usuário para auditoria e compliance.
 */
@Service
@Slf4j
public class SecurityContextService {
     ...
     * Retorna "anonymous" se não houver autenticação.
     */
