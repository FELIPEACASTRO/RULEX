...
/**
 * Entidade que registra a decisão tomada para uma transação.
 * Inclui a classificação, regras aplicadas e scores calculados para auditoria.
 */
@Entity
@Table(name = "transaction_decisions", indexes = {
