 ...
 */
@Entity
@Table(name = "rule_context_variables",
...
public class RuleContextVariable {
    ...
    public enum SourceType {
        ...
        /**
         * Lookup em tabela externa ou cache
         * Config: { "table": "blacklist", "key": "pan", "field": "risk_level" }
         */
        LOOKUP,

        /**
         * Agregação de dados históricos
         * Config: { "metric": "count", "field": "transactionAmount", "period": "24h", "groupBy": "pan" }
         */
        AGGREGATION,

        /**
         * Chamada a serviço externo
         * Config: { "url": "https://api.example.com/score", "method": "POST" }
         */
        EXTERNAL_SERVICE,
