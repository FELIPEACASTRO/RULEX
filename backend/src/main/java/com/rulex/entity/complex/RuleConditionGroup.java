...
/**
 * Entidade para grupos de condições com suporte a aninhamento.
 * Permite criar estruturas complexas como: (A AND B) OR (C AND D)
 */
@Entity
@Table(name = "rule_condition_groups", indexes = {
