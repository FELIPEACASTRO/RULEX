...
/**
 * Entidade que armazena configurações dinâmicas de regras.
 * Permite ajustar pesos, thresholds e flags sem necessidade de redeploy.
 */
@Entity
@Table(name = "rule_configurations", indexes = {
