...
/**
 * Entidade que representa uma transação de crédito a ser analisada.
 * Mapeia todos os parâmetros relevantes do JSON de transação.
 */
@Entity
@Table(name = "transactions", indexes = {
    ...
    @Index(name = "idx_external_transaction_id", columnList = "external_transaction_id", unique = true)
})
@Data
@NoArgsConstructor
@AllArgsConstructor
