...
/**
 * DTO para regras complexas com suporte completo a grupos aninhados,
 * expressões calculadas, variáveis de contexto e ações.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class ComplexRuleDTO {
     ...
     */
    @Valid
    private List<ContextVariableDTO> contextVariables;
