 ...
 * 
 * <p>Resolve vulnerabilidade ReDoS (CVSS 7.5) identificada no Triple-Check
 * validando formatos antes de processamento.
 * 
 * <p>Formatos suportados:
 * <ul>
 *   <li>Simples: "30" (um valor numérico)</li>
 *   <li>Threshold/Window: "10|30" (threshold|days)</li>
 *   <li>Colon format: "3:24" (count:hours)</li>
 *   <li>Key/Threshold/Window: "PAN|10|30" (keyType|threshold|days)</li>
 *   <li>Operator format: "30|GT" (threshold|operator)</li>
 * </ul>
 */
@Slf4j
public final class ValueSingleParser {
    ...
    private static final Pattern IDENTIFIER_PATTERN = 
        Pattern.compile("^[A-Z][A-Z0-9_]{0,30}$");
    ...
    public static ThresholdOperator parseThresholdOperator(
        ...
        int threshold = parseInt(parts[0], defaultThreshold);
        String operator = parts.length > 1 && IDENTIFIER_PATTERN.matcher(parts[1]).matches() 
            ? parts[1].toUpperCase() 
            : defaultOperator;
