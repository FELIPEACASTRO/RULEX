...
INSERT INTO complex_rules (
    ...
    'ACTIVE',
    false,
    'SYSTEM_MIGRATION_V30'
);

INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_001_HIGH_RISK_COUNTRY_RECURRING'), 1, 'AND');
...
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_001_HIGH_RISK_COUNTRY_RECURRING') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_002_TBML_PROXY_INCOHERENT_PAYMENTS'), 1, 'AND');

-- Condição 1: MCC comercial (atacado, importação)
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_002_TBML_PROXY_INCOHERENT_PAYMENTS') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_003_RAPID_LAYERING'), 1, 'AND');

-- Condição 1: Recebeu transferência nas últimas 2 horas
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_003_RAPID_LAYERING') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_004_MULTI_INSTRUMENT_INTENSIVE_USE'), 1, 'AND');

-- Condição 1: Usou >= 3 tipos de instrumento em 7 dias
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_004_MULTI_INSTRUMENT_INTENSIVE_USE') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_005_SANCTIONS_SCREENING_STRONG_MATCH'), 1, 'AND');

-- Condição: Sanctions Match Score >= 90
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_005_SANCTIONS_SCREENING_STRONG_MATCH') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_006_STRUCTURING_CTR_AVOIDANCE'), 1, 'AND');

-- Condição 1: Múltiplas transações >= 5 em 24 horas
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_006_STRUCTURING_CTR_AVOIDANCE') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_007_RANSOMWARE_PAYMENT_PATTERN'), 1, 'AND');

-- Condição 1: MCC de criptomoeda
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_007_RANSOMWARE_PAYMENT_PATTERN') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_008_POTENTIAL_MULE_ACCOUNT'), 1, 'AND');

-- Condição 1: Recebeu de >= 5 pagadores distintos em 7 dias
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_008_POTENTIAL_MULE_ACCOUNT') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_009_PROFILE_INCONSISTENCY_INCOME_VOLUME'), 1, 'AND');

-- Condição 1: Renda declarada < 3000
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_009_PROFILE_INCONSISTENCY_INCOME_VOLUME') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'AML_010_INCOHERENT_PURPOSE'), 1, 'AND');

-- Condição: Descrição contém palavras suspeitas
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'AML_010_INCOHERENT_PURPOSE') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'ATO_006_MFA_FATIGUE_ATTACK'), 1, 'AND');

-- Condição 1: Contagem de MFA negados >= 5 em 1 hora
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'ATO_006_MFA_FATIGUE_ATTACK') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'ATO_007_SESSION_DEVICE_CHANGE'), 1, 'AND');

-- Condição: Device ID mudou durante a sessão
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'ATO_007_SESSION_DEVICE_CHANGE') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'ATO_008_DATACENTER_LOGIN_FINANCIAL_ACTION'), 1, 'AND');

-- Condição 1: IP é de datacenter/proxy
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'ATO_008_DATACENTER_LOGIN_FINANCIAL_ACTION') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'ATO_009_DORMANT_ACCOUNT_REACTIVATION'), 1, 'AND');

-- Condição 1: Conta estava inativa por >= 90 dias
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'ATO_009_DORMANT_ACCOUNT_REACTIVATION') AND group_order = 1),
...
INSERT INTO rule_condition_groups (complex_rule_id, group_order, logic_operator)
VALUES ((SELECT id FROM complex_rules WHERE rule_key = 'ATO_010_INCOMPATIBLE_USER_AGENTS'), 1, 'AND');

-- Condição: Contagem de user-agents distintos >= 3 em 1 hora
INSERT INTO rule_conditions (condition_group_id, condition_order, field_name, operator, comparison_value, data_type)
VALUES (
    (SELECT id FROM rule_condition_groups WHERE complex_rule_id = (SELECT id FROM complex_rules WHERE rule_key = 'ATO_010_INCOMPATIBLE_USER_AGENTS') AND group_order = 1),
