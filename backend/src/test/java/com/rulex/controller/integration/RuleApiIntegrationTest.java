...
/**
 * 🔥 TESTES INTEGRADOS - API DE REGRAS
 * Testa RuleController, ComplexRuleController, ComplexRuleCrudController
 */
...
public class RuleApiIntegrationTest extends BaseIntegrationTest {
    ...
    private Map<String, Object> createNestedGroupRule() {
        ...
        subGroup1.put("conditions", List.of(
        ...
        subGroup2.put("conditions", List.of(
