...
class HomologSimulationIT {
    ...
    void createsRule_publishes_ruleset_activates_and_simulates() {
        ...
        CreateRuleRequest createRule = new CreateRuleRequest(
                "RISK_MCC_7995",
                "MCC alto risco",
                10,
                40,
        ...
        ResponseEntity<Map<String, Object>> ruleResp = http.exchange(
        ...
        ResponseEntity<Map<String, Object>> publishResp = http.exchange(
        ...
        CreateRuleSetRequest createRuleSet = new CreateRuleSetRequest(
                "DEFAULT",
                "RuleSet padrão",
                List.of(ruleVersionId),
                "seed"
        );

        ResponseEntity<Map<String, Object>> rsResp = http.exchange(
        ...
        ResponseEntity<Map<String, Object>> rsPub = http.exchange(
        ...
        ResponseEntity<Void> act = http.exchange(
        ...
        ResponseEntity<Map<String, Object>> simResp = http.exchange(
        ...
        assertThat(simResp.getBody().get("decision")).isEqualTo(DecisionOutcome.SUSPEITA_DE_FRAUDE.name());
        assertThat(Integer.parseInt(String.valueOf(simResp.getBody().get("riskScore")))).isGreaterThanOrEqualTo(40);
    }
