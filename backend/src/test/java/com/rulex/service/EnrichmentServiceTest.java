 ...
 * Valida enriquecimento de BIN e MCC com fallback para valores padrão.
 */
@ExtendWith(MockitoExtension.class)
class EnrichmentServiceTest {

    @Mock
    private BinLookupRepository binLookupRepository;

    @Mock
    private MccCategoryRepository mccCategoryRepository;
    ...
    class EnrichBinTests {
        ...
        void shouldEnrichFoundBin() {
            BinLookup lookup = BinLookup.builder()
                    .bin("411111")
                    .cardBrand("VISA")
                    .cardType("CREDIT")
                    .cardLevel("PLATINUM")
        ...
        void shouldConvertToMap() {
            EnrichmentService.BinEnrichment enrichment = EnrichmentService.BinEnrichment.builder()
                    .bin("411111")
                    .cardBrand("VISA")
                    .cardType("CREDIT")
                    .found(true)
    ...
    class EnrichMccTests {
        ...
        void shouldEnrichFoundMcc() {
            MccCategory category = MccCategory.builder()
                    .mcc(7995)
                    .category("GAMBLING")
                    .subcategory("BETTING")
        ...
        void shouldConvertToMap() {
            EnrichmentService.MccEnrichment enrichment = EnrichmentService.MccEnrichment.builder()
                    .mcc(7995)
                    .category("GAMBLING")
                    .riskLevel("CRITICAL")
                    .isHighRisk(true)
    ...
    class EnrichTests {
        ...
        void shouldEnrichCompleteTransaction() {
            ...
            BinLookup binLookup = BinLookup.builder()
                    .bin("411111")
                    .cardBrand("VISA")
                    .cardType("CREDIT")
                    .issuerCountry("BRA")
            ...
            MccCategory mccCategory = MccCategory.builder()
                    .mcc(5411)
                    .category("RETAIL")
                    .subcategory("GROCERY")
                    .riskLevel("LOW")
