...
/**
 * Testes de edge cases para todos os operadores.
 * GAP-001: Aumentar cobertura de testes para 95%
 * 
 * Verifica comportamento com:
 * - Valores NULL
 * - Strings vazias
 * - Listas vazias
 * - Valores extremos
...
public class OperatorNullEdgeCaseTest {
    ...
    private static final Set<String> NULL_RETURNS_FALSE = Set.of(
        "GT", "GTE", "LT", "LTE", "CONTAINS", "NOT_CONTAINS",
        "STARTS_WITH", "ENDS_WITH", "REGEX", "NOT_REGEX",
        "BETWEEN", "NOT_BETWEEN", "IN", "ARRAY_CONTAINS"
    );

    // Operadores que devem retornar TRUE com NULL
    private static final Set<String> NULL_RETURNS_TRUE = Set.of(
        "IS_NULL", "NOT_IN"
    );
    ...
    void testOperatorNullBehaviorIsDefined(ConditionOperator op) {
        ...
        boolean isSpecialOperator = opName.startsWith("NEO4J_") 
