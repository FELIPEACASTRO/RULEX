...
class AmountOperatorEvaluatorTest {
    ...
    class AmountDeviationFromAvgTests {
        ...
        void shouldReturnTrueWhenDeviationExceedsThreshold() {
            RuleCondition condition = createCondition("amount", ConditionOperator.AMOUNT_DEVIATION_FROM_AVG, "2");
    ...
    class AmountRoundingBehaviorTests {
        ...
        void shouldDetectRoundingBehavior() {
            RuleCondition condition = createCondition("amount", ConditionOperator.AMOUNT_ROUNDING_BEHAVIOR, null);
            EvaluationContext context = createContext(Map.of(
                "amount", 1000.0,
                "roundAmountCount", 8,
    ...
    class AmountSumPerCardHourTests {
        ...
        void shouldReturnTrueWhenSumExceedsThreshold() {
            RuleCondition condition = createCondition("amount", ConditionOperator.AMOUNT_SUM_PER_CARD_HOUR, "5000");
            EvaluationContext context = createContext(Map.of(
    ...
    class AmountSumPerCustomerDayTests {
        ...
        void shouldReturnTrueWhenSumExceedsThreshold() {
            RuleCondition condition = createCondition("amount", ConditionOperator.AMOUNT_SUM_PER_CUSTOMER_DAY, "10000");
            EvaluationContext context = createContext(Map.of(
                "customerId", "customer-123",
                "amountSumPerCustomerDay", 15000.0
            ));
    ...
    class AmountVarianceAnomalyTests {
        ...
        void shouldDetectVarianceAnomaly() {
            RuleCondition condition = createCondition("amount", ConditionOperator.AMOUNT_VARIANCE_ANOMALY, null);
            EvaluationContext context = createContext(Map.of(
    ...
    class RoundAmountFrequencyTests {
        ...
        void shouldDetectHighRoundAmountFrequency() {
            RuleCondition condition = createCondition("amount", ConditionOperator.ROUND_AMOUNT_FREQUENCY, "0.5");
            EvaluationContext context = createContext(Map.of(
                "roundAmountFrequency", 0.8
            ));
    ...
    class SmallAmountVelocityTests {
        ...
        void shouldDetectHighSmallAmountVelocity() {
            RuleCondition condition = createCondition("amount", ConditionOperator.SMALL_AMOUNT_VELOCITY, "10");
            EvaluationContext context = createContext(Map.of(
                "smallAmountCount", 15,
                "amount", 50.0
            ));
    ...
    class LargeAmountFrequencyTests {
        ...
        void shouldDetectHighLargeAmountFrequency() {
            RuleCondition condition = createCondition("amount", ConditionOperator.LARGE_AMOUNT_FREQUENCY, "0.3");
            EvaluationContext context = createContext(Map.of(
                "largeAmountFrequency", 0.5
            ));
