...
class AccountOperatorEvaluatorTest {
  ...
  class AccountAgeLtMinutesTests {
    ...
    void shouldReturnTrueWhenAccountYoungerThanThreshold() {
      RuleCondition condition =
          createCondition("accountAge", ConditionOperator.ACCOUNT_AGE_LT_MINUTES, "60");
    ...
    void accountAgeLtMinutesShouldCompareCorrectly(
        int ageMinutes, int threshold, boolean expected) {
      RuleCondition condition =
          createCondition(
              "accountAge", ConditionOperator.ACCOUNT_AGE_LT_MINUTES, String.valueOf(threshold));
  ...
  class DaysSinceLastActivityTests {
    ...
    void shouldReturnTrueWhenDaysExceedThreshold() {
      RuleCondition condition =
          createCondition("activity", ConditionOperator.DAYS_SINCE_LAST_ACTIVITY, "30");
  ...
  class ChargebackRateGtTests {
    ...
    void shouldReturnTrueWhenChargebackRateExceedsThreshold() {
      RuleCondition condition =
          createCondition("chargebackRate", ConditionOperator.CHARGEBACK_RATE_GT, "0.01");
    ...
    void chargebackRateGtShouldCompareCorrectly(double rate, double threshold, boolean expected) {
      RuleCondition condition =
          createCondition(
              "chargebackRate", ConditionOperator.CHARGEBACK_RATE_GT, String.valueOf(threshold));
  ...
  class AccountTakeoverPatternTests {
    ...
    void shouldDetectAccountTakeoverPattern() {
      RuleCondition condition =
          createCondition("account", ConditionOperator.ACCOUNT_TAKEOVER_PATTERN, null);
  ...
  class AccountLinkDepthTests {
    ...
    void shouldReturnTrueWhenLinkDepthExceedsThreshold() {
      RuleCondition condition =
          createCondition("accountLinks", ConditionOperator.ACCOUNT_LINK_DEPTH, "3");
  ...
  class EdgeCaseTests {
    ...
    void shouldHandleInvalidThresholdGracefully() {
      RuleCondition condition =
          createCondition("accountAge", ConditionOperator.ACCOUNT_AGE_LT_MINUTES, "invalid");
      EvaluationContext context = createContext(Map.of("accountAgeMinutes", 30));
