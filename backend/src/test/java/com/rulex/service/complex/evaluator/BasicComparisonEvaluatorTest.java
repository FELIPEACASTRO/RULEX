...
class BasicComparisonEvaluatorTest {
    ...
    private RuleCondition createConditionWithArray(String fieldName, ConditionOperator operator, List<String> values) {
        RuleCondition condition = new RuleCondition();
        condition.setFieldName(fieldName);
        condition.setOperator(operator);
    ...
    class NumericComparisonTests {
        ...
        void gtShouldCompareCorrectly(int fieldValue, int threshold, boolean expected) {
            RuleCondition condition = createCondition("amount", ConditionOperator.GT, String.valueOf(threshold));
        ...
        void gteShouldCompareCorrectly(int fieldValue, int threshold, boolean expected) {
            RuleCondition condition = createCondition("amount", ConditionOperator.GTE, String.valueOf(threshold));
            EvaluationContext context = createContext(Map.of("amount", fieldValue));
        ...
        void ltShouldCompareCorrectly(int fieldValue, int threshold, boolean expected) {
            RuleCondition condition = createCondition("amount", ConditionOperator.LT, String.valueOf(threshold));
            EvaluationContext context = createContext(Map.of("amount", fieldValue));
        ...
        void lteShouldCompareCorrectly(int fieldValue, int threshold, boolean expected) {
            RuleCondition condition = createCondition("amount", ConditionOperator.LTE, String.valueOf(threshold));
            EvaluationContext context = createContext(Map.of("amount", fieldValue));
    ...
    class InOperatorTests {
        ...
        void inShouldReturnTrueWhenValueInList() {
            RuleCondition condition = createConditionWithArray("country", ConditionOperator.IN,
                List.of("BR", "US", "UK"));
        ...
        void notInShouldReturnTrueWhenValueNotInList() {
            RuleCondition condition = createConditionWithArray("country", ConditionOperator.NOT_IN,
                List.of("RU", "KP", "IR"));
            EvaluationContext context = createContext(Map.of("country", "BR"));
        ...
        void inShouldBeCaseInsensitive() {
            RuleCondition condition = createConditionWithArray("status", ConditionOperator.IN,
