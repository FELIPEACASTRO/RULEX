...
class RuleEngineServiceTest {
  ...
  void triggersLegacyRule_andImpactsDecision(
    ...
    assertThat(response.getTriggeredRules())
        .withFailMessage(
            ...
            ruleName, spec.conditionsJson, req.getMcc(), req.getMerchantCountryCode())
        .hasSize(1);
  ...
  void triggersBlocklistPanRule_whenDbRuleEnabled_andBloomEnabled() throws Exception {
    ...
    String conditionsJson =
        objectMapper.writeValueAsString(
            List.of(
                java.util.Map.of("field", "isBlacklistedPan", "operator", "IS_TRUE", "value", "")));
  ...
  private record LegacyRuleSpec(
      String conditionsJson, RuleConfiguration.LogicOperator logicOperator) {}
    ...
    try {
      ...
      switch (ruleName) {
        ...
        case "INVALID_CAVV" ->
            conditions =
                java.util.List.of(
                    java.util.Map.of("field", "cavvResult", "operator", "NE", "value", "0"));
        ...
        case "CVV_MISMATCH" ->
            conditions =
                java.util.List.of(
                    java.util.Map.of("field", "cvv2Response", "operator", "EQ", "value", "N"));
        ...
        case "INTERNATIONAL_TRANSACTION" ->
            conditions =
                java.util.List.of(
                    java.util.Map.of(
                        "field", "merchantCountryCode", "operator", "IS_NOT_NULL", "value", ""),
                    java.util.Map.of(
        ...
        case "PIN_VERIFICATION_FAILED" ->
            conditions =
                java.util.List.of(
                    java.util.Map.of("field", "pinVerifyCode", "operator", "EQ", "value", "I"));
        case "CVV_PIN_LIMIT_EXCEEDED" ->
            conditions =
                java.util.List.of(
                    java.util.Map.of(
                        "field", "cvvPinTryLimitExceeded", "operator", "EQ", "value", "1"));
        case "OFFLINE_PIN_FAILED" ->
            conditions =
                java.util.List.of(
                    java.util.Map.of(
