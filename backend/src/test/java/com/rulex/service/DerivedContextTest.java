...
/**
 * Testes unitários para DerivedContext.
 * Valida parsing de tipos derivados sem alterar o payload original.
 */
class DerivedContextTest {
    ...
    class DeriveTimestampTests {
        ...
        void shouldReturnEmptyWhenDateIsNull() {
            Optional<OffsetDateTime> result = DerivedContext.deriveTimestamp(null, LocalTime.NOON, "-0300");
        ...
        void shouldReturnEmptyWhenTimeIsNull() {
            Optional<OffsetDateTime> result = DerivedContext.deriveTimestamp(LocalDate.now(), null, "-0300");
