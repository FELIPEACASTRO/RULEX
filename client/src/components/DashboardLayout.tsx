...
import { LayoutDashboard, LogOut, PanelLeft, Users, FileText, Settings, Zap, Database } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Settings, label: "Regras", path: "/rules" },
  { icon: Database, label: "Features", path: "/features" },
