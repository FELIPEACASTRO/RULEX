...
export const COMPARISON_OPERATORS: OperatorInfo[] = [
  ...
  // ============================================
  // OPERADORES SYNC FINAL (29 novos)
  // ============================================
  { value: 'MCC_ANOMALY', label: 'MCC anomaly', description: 'Anomalia de MCC', category: 'advanced', requiresValue: false, applicableTypes: ['BOOLEAN'] },
  { value: 'MERCHANT_ANOMALY', label: 'Merchant anomaly', description: 'Anomalia de merchant', category: 'advanced', requiresValue: false, applicableTypes: ['BOOLEAN'] },
  { value: 'NAME_SIMILARITY_GT', label: 'Name similarity greater than', description: 'Similaridade de nome maior que', category: 'advanced', requiresValue: true, applicableTypes: ['NUMBER'] },
  { value: 'RECIPIENT_IN_WATCHLIST', label: 'Recipient in watchlist', description: 'Destinatário na watchlist', category: 'advanced', requiresValue: false, applicableTypes: ['BOOLEAN'] },
  { value: 'RECIPIENT_IS_NEW', label: 'Recipient is new', description: 'Destinatário é novo', category: 'advanced', requiresValue: false, applicableTypes: ['BOOLEAN'] },
  { value: 'SUSPICIOUS_TRANSACTION_TYPE', label: 'Suspicious transaction type', description: 'Tipo de transação suspeito', category: 'advanced', requiresValue: false, applicableTypes: ['BOOLEAN'] },
];
