...
export default function DmnRenderer({ source }: Props) {
  ...
  return (
    <div className="h-full w-full overflow-auto rounded-md border bg-muted/20 p-4">
      <div className="mb-3 text-sm text-muted-foreground">
        Renderer DMN pendente. Este viewer exibe o XML/JSON para futura
        integração (viewer DMN nativo ou biblioteca dmn-js).
      </div>
